...
mongoose
  ...
  .then(async () => {
    ...
    if (count > 0) {
      ...
      console.log(
        `��� Sample employee: ${sample.name} - ${sample.department} - ${sample.riskScore}%`,
      );
    }
  })
  .catch((err) => {
...
app.listen(PORT, '0.0.0.0', () => {
  ...
  console.log(`��� Demo available: http://localhost:${PORT}/api/demo/health`);
  console.log(`��� Demo credentials: demo / prometheus2025`);
});
