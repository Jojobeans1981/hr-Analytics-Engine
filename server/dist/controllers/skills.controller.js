...
class SkillsController {
    static async extractSkills(req, res) {
        try {
            const { text } = req.body;
            ...
            const result = {
                ...
                categories: {
                    technical: foundSkills.filter(skill => !['communication', 'problem solving', 'teamwork', 'creativity', 'leadership', 'project management', 'agile', 'scrum'].includes(skill)),
                    soft: foundSkills.filter(skill => ['communication', 'problem solving', 'teamwork', 'creativity', 'leadership', 'project management', 'agile', 'scrum'].includes(skill))
                }
            };
            res.json({
                success: true,
    ...
    static async analyzeTeamSkills(req, res) {
        try {
